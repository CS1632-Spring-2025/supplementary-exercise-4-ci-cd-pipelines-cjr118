...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		// Filled in
			c1 = mock(Cat.class);
		        ...
		        when(c1.toString()).thenReturn("ID1.Jennyanydots");
		...
		// Filled in
			c2 = mock(Cat.class);
		        ...
		        when(c2.toString()).thenReturn("ID2.Old Deuteronomy");
		...
		// Filled in
			c3 = mock(Cat.class);
		        ...
		        when(c3.toString()).thenReturn("ID3.Mistoffelees");
		...
		// Filled in.  Refer to the textbook chapter 14.6 on Testing System Output.
			stdout = System.out;
	...
	public void testListCatsNumCats0() {
		// Filled in
		 r = new RentACatImpl(); // No cats added
	...
	public void testListCatsNumCats3() {
		// Filled in
		String expected = "ID1.Jennyanydots\nID2.Old Deuteronomy\nID3.Mistoffelees";
